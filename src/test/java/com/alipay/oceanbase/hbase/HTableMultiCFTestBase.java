...
public abstract class HTableMultiCFTestBase {
    ...
    public void testDeleteFamilyVerison() throws Exception {
        ...
        putKey3Fam2Column3Ts7
            .add(toBytes(family2), toBytes(column3), timeStamp7, toBytes(value1));

        Put putKey3Fam2Column1Ts7 = new Put(toBytes(key3));
        putKey3Fam2Column1Ts7
            .add(toBytes(family2), toBytes(column1), timeStamp7, toBytes(value2));
