...
public class JMXMetricsTest {
    ...
    public void testMetricsRegisteredInJMX() throws Exception {
        if (metrics == null) {
            Assert.assertTrue("for testing Metrics in JMX, set CLIENT_SIDE_METRICS_ENABLED_KEY",
                false);
        }
    ...
    public void testPutMetricsViaJMX() throws Exception {
        ...
        JMXMetricsTestHelper.JMXMetricsInfo initialInfo = jmxHelper.getMetricsInfo(
            OHOperationType.PUT, metricsName);
        ...
        JMXMetricsTestHelper.JMXMetricsInfo updatedInfo = jmxHelper.getMetricsInfo(
            OHOperationType.PUT, metricsName);
    ...
    public void testGetMetricsViaJMX() throws Exception {
        ...
        JMXMetricsTestHelper.JMXMetricsInfo initialInfo = jmxHelper.getMetricsInfo(
            OHOperationType.GET, metricsName);
    ...
    public void testFailedOperationMetricsViaJMX() throws Exception {
        ...
        Long oldFailedOpCount = (Long) jmxHelper.getMeterAttribute(OHOperationType.PUT,
            metricsName, "Count");
        Double oldMeanFailRate = (Double) jmxHelper.getMeterAttribute(OHOperationType.PUT,
            metricsName, "MeanRate");
        Assert.assertTrue("Failed operation count should be 0", oldFailedOpCount == 0);
        Assert.assertTrue("Failed operation mean rate should be 0", oldMeanFailRate == 0);
        ...
        Long newFailedOpCount = (Long) jmxHelper.getMeterAttribute(OHOperationType.PUT,
            metricsName, "Count");
        Double newMeanFailRate = (Double) jmxHelper.getMeterAttribute(OHOperationType.PUT,
            metricsName, "MeanRate");
        ...
        Assert.assertTrue("Failed operation mean rate should be > 0", newMeanFailRate > 0);
    }
    ...
    public void testJMXLatencyHistogramAccess() throws Exception {
        ...
        Long count = (Long) jmxHelper.getTimerAttribute(OHOperationType.PUT, metricsName, "Count");
        Double averageLatency = (Double) jmxHelper.getTimerAttribute(OHOperationType.PUT,
            metricsName, "MeanRate");
        Double p99 = (Double) jmxHelper.getTimerAttribute(OHOperationType.PUT, metricsName,
            "99thPercentile");
    ...
    public void testJMXCounterAccess() throws Exception {
        ...
        Long initialSingleOpCount = (Long) jmxHelper.getCounterAttribute(OHOperationType.PUT,
            metricsName, "totalSingleOpCount", "Count");
        Long initialRuntime = (Long) jmxHelper.getCounterAttribute(OHOperationType.PUT,
            metricsName, "totalRuntime", "Count");
        ...
        Long updatedSingleOpCount = (Long) jmxHelper.getCounterAttribute(OHOperationType.PUT,
            metricsName, "totalSingleOpCount", "Count");
        Long updatedRuntime = (Long) jmxHelper.getCounterAttribute(OHOperationType.PUT,
            metricsName, "totalRuntime", "Count");

        System.out.println("Counter metrics:");
        System.out.println("  totalSingleOpCount: " + initialSingleOpCount + " -> "
                           + updatedSingleOpCount);
        ...
        Assert.assertTrue("totalRuntime should increase", updatedRuntime > initialRuntime);
    }
    ...
    public void testMetricsExporterVSJMX() throws Exception {
        ...
        JMXMetricsTestHelper.JMXMetricsInfo jmxInfo = jmxHelper.getMetricsInfo(OHOperationType.PUT,
            metricsName);
        ...
        Assert.assertEquals("99thPercentile should match", exporterP99, jmxInfo.P99thPercentile,
            0.001);
        Assert.assertEquals("FailCount should match", exporterFailCount, jmxInfo.failedOpCount);
    }

    private void JMXChecker(OHOperationType type, JMXMetricsTestHelper.JMXMetricsInfo oldInfo,
