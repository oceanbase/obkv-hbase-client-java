...
public class OHTableSecondaryPartGetOptimizeTest {
    ...
    public void testGetOptimizeWithSpecificTimestampOnRangeKey() throws Exception {
        ...
        put = new Put(toBytes(key));
        put.add(family.getBytes(), column.getBytes(), t4, toBytes("value_t4"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), column.getBytes(), t5, toBytes("value_t5"));
        hTable.put(put);
        ...
        r = hTable.get(get);
        Assert.assertEquals(1, r.raw().length);
        Assert.assertEquals("value_t5", Bytes.toString(r.raw()[0].getValue()));
        Assert.assertEquals(t5, r.raw()[0].getTimestamp());
        ...
        r = hTable.get(get);
        Assert.assertEquals(1, r.raw().length);
        Assert.assertEquals("value_t4", Bytes.toString(r.raw()[0].getValue()));
        Assert.assertEquals(t4, r.raw()[0].getTimestamp());
    }
    ...
    public void testGetOptimizeWithMultipleQualifiersOnRangeKey() throws Exception {
        ...
        Put put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t1, toBytes("q1_value_1"));
        put.add(family.getBytes(), col2.getBytes(), t1, toBytes("q2_value_1"));
        put.add(family.getBytes(), col3.getBytes(), t1, toBytes("q3_value_1"));
        put.add(family.getBytes(), col4.getBytes(), t1, toBytes("q4_value_1"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t2, toBytes("q1_value_2"));
        put.add(family.getBytes(), col2.getBytes(), t2, toBytes("q2_value_2"));
        put.add(family.getBytes(), col3.getBytes(), t2, toBytes("q3_value_2"));
        put.add(family.getBytes(), col4.getBytes(), t2, toBytes("q4_value_2"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t3, toBytes("q1_value_3"));
        put.add(family.getBytes(), col2.getBytes(), t3, toBytes("q2_value_3"));
        put.add(family.getBytes(), col3.getBytes(), t3, toBytes("q3_value_3"));
        put.add(family.getBytes(), col4.getBytes(), t3, toBytes("q4_value_3"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t4, toBytes("q1_value_4"));
        put.add(family.getBytes(), col2.getBytes(), t4, toBytes("q2_value_4"));
        put.add(family.getBytes(), col3.getBytes(), t4, toBytes("q3_value_4"));
        put.add(family.getBytes(), col4.getBytes(), t4, toBytes("q4_value_4"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t5, toBytes("q1_value_5"));
        put.add(family.getBytes(), col2.getBytes(), t5, toBytes("q2_value_5"));
        put.add(family.getBytes(), col3.getBytes(), t5, toBytes("q3_value_5"));
        put.add(family.getBytes(), col4.getBytes(), t5, toBytes("q4_value_5"));
        hTable.put(put);
    ...
    public void testGetOptimizeWithMultipleQualifiersAndTimestamp() throws Exception {
        ...
        System.out.println(Arrays.toString(r.raw()));
        Assert.assertEquals(3, r.raw().length);
    ...
    public void testGetOptimizeWithMultipleQualifiersAcrossPartitions() throws Exception {
        ...
        Put put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t1, toBytes("col1_p1"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t2, toBytes("col1_p2"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t3, toBytes("col1_p3"));
        hTable.put(put);
        
        put = new Put(toBytes(key));
        put.add(family.getBytes(), col2.getBytes(), t1, toBytes("col2_p1_v1"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col2.getBytes(), t4, toBytes("col2_p1_v2"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col3.getBytes(), t1, toBytes("col3_p1"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col3.getBytes(), t5, toBytes("col3_p2"));
        hTable.put(put);
    ...
    public void testGetOptimizeWithoutQualifierOnKeyRange() throws Exception {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            Put put = new Put(toBytes(key));
            put.add(family.getBytes(), col1.getBytes(), ts, toBytes("col1_value_" + i));
            put.add(family.getBytes(), col2.getBytes(), ts, toBytes("col2_value_" + i));
            put.add(family.getBytes(), col3.getBytes(), ts, toBytes("col3_value_" + i));
            hTable.put(put);
            Thread.sleep(5);
        }
    ...
    public void testGetOptimizeWithoutQualifierOnRangeKey() throws Exception {
        ...
        Put put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t1, toBytes("q1_v1"));
        put.add(family.getBytes(), col2.getBytes(), t1, toBytes("q2_v1"));
        put.add(family.getBytes(), col3.getBytes(), t1, toBytes("q3_v1"));
        put.add(family.getBytes(), col4.getBytes(), t1, toBytes("q4_v1"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t2, toBytes("q1_v2"));
        put.add(family.getBytes(), col2.getBytes(), t2, toBytes("q2_v2"));
        put.add(family.getBytes(), col3.getBytes(), t2, toBytes("q3_v2"));
        put.add(family.getBytes(), col4.getBytes(), t2, toBytes("q4_v2"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t3, toBytes("q1_v3"));
        put.add(family.getBytes(), col2.getBytes(), t3, toBytes("q2_v3"));
        put.add(family.getBytes(), col3.getBytes(), t3, toBytes("q3_v3"));
        put.add(family.getBytes(), col4.getBytes(), t3, toBytes("q4_v3"));
        hTable.put(put);
    ...
    public void testGetOptimizeWithoutQualifierAndTimestampOnKeyRange() throws Exception {
        ...
        Put put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t1, toBytes("qa_t1"));
        put.add(family.getBytes(), col2.getBytes(), t1, toBytes("qb_t1"));
        put.add(family.getBytes(), col3.getBytes(), t1, toBytes("qc_t1"));
        hTable.put(put);

        Thread.sleep(10);
        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t2, toBytes("qa_t2"));
        put.add(family.getBytes(), col2.getBytes(), t2, toBytes("qb_t2"));
        put.add(family.getBytes(), col3.getBytes(), t2, toBytes("qc_t2"));
        hTable.put(put);

        Thread.sleep(10);
        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t3, toBytes("qa_t3"));
        put.add(family.getBytes(), col2.getBytes(), t3, toBytes("qb_t3"));
        put.add(family.getBytes(), col3.getBytes(), t3, toBytes("qc_t3"));
        hTable.put(put);
    ...
    public void testGetOptimizeWithoutQualifierAndTimestampOnRangeKey() throws Exception {
        ...
        Put put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t1, toBytes("a_v1"));
        put.add(family.getBytes(), col2.getBytes(), t1, toBytes("b_v1"));
        put.add(family.getBytes(), col3.getBytes(), t1, toBytes("c_v1"));
        put.add(family.getBytes(), col4.getBytes(), t1, toBytes("d_v1"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t2, toBytes("a_v2"));
        put.add(family.getBytes(), col2.getBytes(), t2, toBytes("b_v2"));
        put.add(family.getBytes(), col3.getBytes(), t2, toBytes("c_v2"));
        put.add(family.getBytes(), col4.getBytes(), t2, toBytes("d_v2"));
        hTable.put(put);

        put = new Put(toBytes(key));
        put.add(family.getBytes(), col1.getBytes(), t3, toBytes("a_v3"));
        put.add(family.getBytes(), col2.getBytes(), t3, toBytes("b_v3"));
        put.add(family.getBytes(), col3.getBytes(), t3, toBytes("c_v3"));
        put.add(family.getBytes(), col4.getBytes(), t3, toBytes("d_v3"));
        hTable.put(put);
        ...
        Assert.assertEquals(4, r2.raw().length);
        for (int i = 0; i < r2.raw().length; i++) {
            Assert.assertEquals(t3, r2.raw()[i].getTimestamp());
        }
    }
}
