...
public class JMXMetricsTestHelper {
    ...
    public JMXMetricsInfo getMetricsInfo(OHOperationType opType, String metricsName) {
        ...
        // Counter
        info.totalSingleOpCount = (Long) getCounterAttribute(opType, metricsName, "totalSingleOpCount", "Count");
        ...
        public String toString() {
            return String.format(
                ...
                "P99thPercentile=%.2f, failedOpCount=%d, totalSingleOpCount=%d, totalRuntime=%d }",
                    totalOpCount, meanOps, meanLatency, P99thPercentile,
                    failedOpCount, totalSingleOpCount, totalRuntime);
        }
    }
}
