...
public class ObHTableTestUtil {
    ...
    public static String       PARAM_URL      = "http://ocp-cfg.alibaba.net:8080/services?User_ID=alibaba&UID=test&Action=ObRootServiceInfo&ObCluster=ob14.wuhuang.wh.11.158.77.154&database=test";
    public static String       FULL_USER_NAME = "root@mysql#ob14.wuhuang.wh.11.158.77.154";
    ...
    public static String       JDBC_IP        = "11.162.218.231";
    public static String       JDBC_PORT      = "20013";
